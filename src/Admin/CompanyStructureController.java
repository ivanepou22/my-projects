 ...
 * @author Ivan Epou
 */
public class CompanyStructureController implements Initializable {
    @FXML
...
//        ToolTip for search TextField
        ...
        @FXML
    public void newButtonComp(){
         try {
                FXMLLoader fxmlLoader = new FXMLLoader(getClass().getResource("CompanyStructReg.FXML"));
                Parent border;
                border = (Parent) fxmlLoader.load();
                Stage stage = new Stage();
                stage.setScene(new Scene(border));  
                stage.setTitle("Company Structure");
                stage.show();
