 ...
 * @author Ivan Epou
 */
public class MonitorAttendanceController implements Initializable {
    @FXML
...
//        ToolTip for search TextField
    ...
    @FXML
    public void newButtonAttendance(){
         try {
                FXMLLoader fxmlLoader = new FXMLLoader(getClass().getResource("AttendanceMonitoringReg.FXML"));
                Parent border;
                border = (Parent) fxmlLoader.load();
                Stage stage = new Stage();
                stage.setScene(new Scene(border));  
                stage.setTitle("Attendance Monitoring");
                stage.show();
